  ...
  // Day 1
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <div class="action-box">
        ...
        <p>Open your vault and set a specific savings goal with a target amount. Whether it's $500 for an emergency fund or $2,000 for a vacation — make it real.</p>
      </div>
      ...
      <a href="https://savetogether.co/dashboard" class="cta-button">Set Your Goal</a>
