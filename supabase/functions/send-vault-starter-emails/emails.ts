...
<body>
  <div class="container">
    ...
    <div class="footer">
      ...
      <p><a href="https://savetogether.app">Visit SaveTogether</a></p>
      <p class="unsubscribe">
...
export const challengeEmails: ChallengeEmail[] = [
  ...
  // Day 1
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Create Your Vault</a>
  ...
  // Day 2
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Make Your First Save</a>
  ...
  // Day 3
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Add to Your Vault</a>
  ...
  // Day 4
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Track Your Progress</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 5
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Check Your Vault</a>
  ...
  // Day 6
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Visit Your Vault</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 7
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">See Your Progress</a>
  ...
  // Day 8
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Update Your Vault</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 9
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Invite a Friend</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 10
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/savings-guide" class="cta-button">Read the Savings Guide</a>
      <p style="text-align: center; margin-top: 10px;"><a href="https://savetogether.app/earn-more" style="color: #10b981;">Explore Earn More →</a></p>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 11
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Log Your Savings</a>
  ...
  // Day 12
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Check Your Progress</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
  ...
  // Day 13
  {
    ...
    getHtml: (unsubscribeLink: string) => getEmailWrapper(`
      ...
      <a href="https://savetogether.app/dashboard" class="cta-button">Plan Your Next Goal</a>
      <p>— The SaveTogether Team</p>
    `, unsubscribeLink)
  },
